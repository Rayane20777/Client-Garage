    ...
    <section className="relative min-h-[700px] flex items-center justify-center text-white">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 text-center mt-24">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link 
            href="#contact" 
            className="bg-button-secondary hover:bg-button-secondary/90 text-primary font-bold py-4 px-8 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
          >
            Nous contacter
          </Link>
        </div>
